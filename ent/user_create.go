...
func (uc *UserCreate) SetPk(i int) *UserCreate {
	uc.mutation.SetPk(i)
	return uc
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.Pk(); !ok {
		return &ValidationError{Name: "pk", err: errors.New(`ent: missing required field "User.pk"`)}
	}
