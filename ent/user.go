...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldCreatedAt, user.FieldEditedAt:
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.Pk))
	builder.WriteString(", ")
	...
	builder.WriteString(u.EditedAt.Format(time.ANSIC))
	builder.WriteByte(')')
